module github.com/open-telemetry/opentelemetry-collector-contrib/extension/publicegressextension
...
require (
	...
	go.opentelemetry.io/collector/extension/extensionmiddleware v0.149.0
