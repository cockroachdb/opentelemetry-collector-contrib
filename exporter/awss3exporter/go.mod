...
require (
	...
	go.opentelemetry.io/collector/config/configcompression v1.55.0
	...
	go.opentelemetry.io/collector/otelcol/otelcoltest v0.149.0
...
require (
	...
	go.opentelemetry.io/collector/confmap/provider/httpprovider v1.55.0 // indirect
